	 ...
	 private final Logger logger = Logger.getLogger(DepartamanetosRepositoriesImpl.class.getName());
	    ...
	    public Empleado save(Empleado entity) {
	        ...
	        try {
	            ...
	            throw new DepartamentoExceptions("Error al salvar el empleado con id: " + entity.getId() + "\n" + e.getMessage());
	        } finally {
	    ...
	    public Boolean delete(Empleado entity) {
	        ...
	        try {
	            ...
	            throw new EmpleadoExceptions("Error al eliminar empleado con id: " + entity.getId() + " - " + e.getMessage());
	        } finally {
	            if (hb.getTransaction().isActive()) {
	                hb.getTransaction().rollback();
	            }
